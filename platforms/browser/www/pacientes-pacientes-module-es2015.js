...
/* harmony import */ var _pacientes_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pacientes.page */ "wuyq");
...
class PacientesPageModule {
}
PacientesPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: PacientesPageModule });
PacientesPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function PacientesPageModule_Factory(t) { return new (t || PacientesPageModule)(); }, imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](PacientesPageModule, { declarations: [_pacientes_page__WEBPACK_IMPORTED_MODULE_6__["PacientesPage"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PacientesPageModule, [{
...
function PacientesPage_h4_34_Template(rf, ctx) { if (rf & 1) {
...
function PacientesPage_h4_38_Template(rf, ctx) { if (rf & 1) {
...
function PacientesPage_ion_col_77_canvas_18_Template(rf, ctx) { if (rf & 1) {
...
function PacientesPage_ion_col_77_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](12, "\u00DAltima an\u00E1lise em:");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function PacientesPage_ion_col_77_Template_img_click_15_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r7); const ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r6.get_emot(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](16, "img", 44);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function PacientesPage_ion_col_77_Template_img_click_16_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r7); const ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r8.get_corpo(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](17, "img", 45);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function PacientesPage_ion_col_77_Template_img_click_17_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r7); const ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r9.get_mente(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function PacientesPage_ion_col_77_Template_ion_button_click_21_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r7); const item_r3 = ctx.$implicit; const ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r10.openProntuario(item_r3, "body"); });
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](22, "ion-icon", 50);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](23, "p");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](24, "PRONTU\u00C1RIO");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            if (event.target.value.length > 0) {
                if (/^\d/.test(event.target.value)) {
                    /**/
                    result = this.pacientesOrig.filter((x) => x.cpf.toLowerCase().includes(event.target.value.toLowerCase()));
                    ...
                    result = this.pacientesOrig.filter((x) => x.nome.toLowerCase().includes(event.target.value.toLowerCase()));
                    this.pacientes = result;
                }
                console.log(yield result);
                if ((yield this.pacientes) && (yield this.pacientes.length) > 0) {
                    this.pacientes.forEach((el) => {
                        //this.loadChart(el._id, dataset)
                        setTimeout(() => {
                            this.loadChart("id" + el._id.$oid, {
...
PacientesPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: PacientesPage, selectors: [["app-pacientes"]], decls: 80, vars: 36, consts: [[1, "toolbar-bg"], ["src", "../../assets/images/mia-wht.png", "width", "200", "alt", ""], ["slot", "end", 1, "ion-text-right"], ["wrap-box", ""], [1, "ion-no-padding"], [1, "sub-toolbar"], ["size", "8"], ["size", "4"], ["lines", "none", 1, "search-bar"], ["type", "text", "placeholder", "Pesquise pacientes por nome ou CPF...", 1, "search-input", 3, "ionChange"], ["ios", "ios-search", "md", "md-search", 1, "searchbar-icon"], [1, "card-stats", 2, "margin-left", "0px"], ["size-md", "3", "size-sm", "3", "size-xs", "3", "size-lg", "3"], ["color", "primary", 1, "ion-text-center"], [2, "margin-top", "20px", "font-size", "22px"], [2, "color", "#9f9c9c !important", "font-size", "12px"], ["size-md", "2", "size-sm", "2", "size-lg", "2", "size-xs", "2", 2, "text-align", "center"], [3, "percent", "clockwise", "showTitle", "showSubtitle", "space", "radius", "outerStrokeWidth", "innerStrokeWidth", "outerStrokeColor", "titleColor", "innerStrokeColor", "animation", "animationDuration", "showUnits"], ["size-md", "2.5", "size-sm", "2.5", "size-lg", "2.5", "size-xs", "2.5"], ["style", "color: #2694a3", "class", "h4-stats", 4, "ngIf"], ["style", "color: #ef9c92", "class", "h4-stats", 4, "ngIf"], [1, "card-stats"], ["size", "3"], ["lines", "none", 2, "border-right", "1px solid #999999"], ["color", "secondary", 1, "ion-text-center"], ["name", "sad", 1, "icon-stats"], [1, "p-stats"], ["name", "phone-portrait", 1, "icon-stats"], ["name", "logo-rss", 1, "icon-stats"], ["lines", "none"], ["name", "happy", 1, "icon-stats"], ["sizeLg", "4", "sizeMd", "6", "sizeXs", "12", 4, "ngFor", "ngForOf"], ["loadingSpinner", "bubbles", "loadingText", "Carregando Pacientes...", 3, "ionInfinite"], [1, "h4-stats", 2, "color", "#2694a3"], [1, "h4-stats", 2, "color", "#ef9c92"], ["sizeLg", "4", "sizeMd", "6", "sizeXs", "12"], [1, "slide-card"], ["src", "../../assets/images/person.png", 1, "slide-img"], ["size", "9"], [1, "h4-slide"], [1, "p-slide-title"], [1, "p-slide-subtitle"], ["size", "12"], ["src", "../../assets/images/mind-icon.png", 1, "mind-img", 3, "click"], ["src", "../../assets/images/body-icon.png", 1, "body-img", 3, "click"], ["src", "../../assets/images/emot-icon.png", 1, "emot-img", 3, "click"], ["style", "margin-top: 45px", "width", "300", "height", "320", "responsive", "true", 3, "id", 4, "ngIf"], [2, "margin-top", "-12%"], ["size", "12", 2, "padding", "0px"], ["expand", "block", "color", "secondary", 1, "slide-btn", 3, "click"], ["slot", "start", "name", "heart", 2, "color", "#00000042"], ["width", "300", "height", "320", "responsive", "true", 2, "margin-top", "45px", 3, "id"]], template: function PacientesPage_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](15, "Gerenciamento todos os seus pacientes em um \u00FAnico lugar");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ionChange", function PacientesPage_Template_ion_input_ionChange_18_listener($event) { return ctx.searchPatient($event); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ionInfinite", function PacientesPage_Template_ion_infinite_scroll_ionInfinite_78_listener($event) { return ctx.loadNextPage($event); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](PacientesPage, [{
    ...
    }], function () { return [{ type: _services_api_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] }, { type: _services_storage_storage_service__WEBPACK_IMPORTED_MODULE_3__["StorageService"] }, { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"] }]; }, null); })();
