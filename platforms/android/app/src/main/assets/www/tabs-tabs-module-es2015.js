...
TabsPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TabsPage, selectors: [["app-tabs"]], decls: 18, vars: 0, consts: [["slot", "bottom", 1, "tabs-bg"], [2, "width", "100%"], ["size", "4"], ["tab", "dashboard", 1, "tabs-btn"], ["name", "pulse"], ["tab", "pacientes", 1, "tabs-btn"], ["name", "happy"], ["tab", "data", 1, "tabs-btn"], ["name", "cloud-outline"]], template: function TabsPage_Template(rf, ctx) { if (rf & 1) {
        ...
        children: [
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: () => Promise.all(/*! import() | dashboard-dashboard-module */[__webpack_require__.e("default~dashboard-dashboard-module~pacientes-pacientes-module~prontuario-prontuario-module"), __webpack_require__.e("dashboard-dashboard-module")]).then(__webpack_require__.bind(null, /*! ../dashboard/dashboard.module */ "TDBs")).then(m => m.DashboardPageModule)
                    }
                ],
            },
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: () => Promise.all(/*! import() | pacientes-pacientes-module */[__webpack_require__.e("default~dashboard-dashboard-module~pacientes-pacientes-module~prontuario-prontuario-module"), __webpack_require__.e("pacientes-pacientes-module")]).then(__webpack_require__.bind(null, /*! ../pacientes/pacientes.module */ "sPQD")).then(m => m.PacientesPageModule)
                    }
                ],
            },
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: () => __webpack_require__.e(/*! import() | data-data-module */ "data-data-module").then(__webpack_require__.bind(null, /*! ../data/data.module */ "MgIx")).then(m => m.DataPageModule)
                    }
                ],
            },
            {
...
TabsPageRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function TabsPageRoutingModule_Factory(t) { return new (t || TabsPageRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]] });
