...
const { apiURL } = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"];
class AuthService {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.http.post(`${apiURL}/login`, fd, { headers: headers }).subscribe((res) => {
                if (res && res.token) {
                    ...
                    this.storage.set('mia_access_token', res.token).then(() => {
                        //call /profile to request user data
                        setTimeout(() => {
                            this.http.get(`${apiURL}/perfil`, {
                                headers: {
                                    'Bearer': res.token
                                }
                            }).subscribe((user) => {
                                this.storage.set('mia_user_data', user.Perfil).then(() => {
                                    resolve(true);
                                }).catch((err) => {
                                    reject(err);
                                });
...
AuthService.ɵfac = function AuthService_Factory(t) { return new (t || AuthService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_storage_storage_service__WEBPACK_IMPORTED_MODULE_2__["StorageService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AuthService, [{
    ...
    }], function () { return [{ type: _storage_storage_service__WEBPACK_IMPORTED_MODULE_2__["StorageService"] }, { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] }]; }, null); })();
