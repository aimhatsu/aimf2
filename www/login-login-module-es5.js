(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
    ...
    "34Y5": function Y5(module, __webpack_exports__, __webpack_require__) {
      ...
      function LoginPage_ion_spinner_25_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var LoginPage = /*#__PURE__*/function () {
        function LoginPage(navCtrl, util, auth, storage) {
        ...
        _createClass(LoginPage, [{
          ...
          value: function login() {
            ...
            if (this.user.email != "" && this.user.password != "") {
              this.isLoading = true;
              this.auth.login(this.user.email, this.user.password).then(function (response) {
                ...
                _this.util.presentErr(JSON.stringify(err.statusText), JSON.stringify(err.message));
      ...
      LoginPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 32,
        vars: 4,
        consts: [[1, "user-login-area"], [1, "container"], [1, "row"], [1, "col-md-12"], [1, "single-user-area"], [1, "login-area"], [1, "ion-text-center"], ["src", "../../assets/images/mia-wht.png", "alt", ""], ["color", "transparent"], ["slot", "start", "name", "person", 1, "side-icon"], ["type", "email", 3, "ngModel", "ngModelChange"], ["slot", "start", "name", "lock", 1, "side-icon"], ["type", "password", 3, "ngModel", "ngModelChange"], ["expand", "block", "shape", "round", "color", "light", 3, "click"], [4, "ngIf"], ["color", "dark", 4, "ngIf"], [1, "privacy-area"], ["fill", "clear", "color", "secondary", 3, "click"], ["color", "dark"]],
        template: function LoginPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function LoginPage_Template_ion_input_ngModelChange_15_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function LoginPage_Template_ion_input_ngModelChange_21_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginPage_Template_ion_button_click_29_listener() {
              return ctx.register();
            });
