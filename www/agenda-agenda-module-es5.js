(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["agenda-agenda-module"], {
    /***/
    "CigD": function CigD(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      AgendaPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function AgendaPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](15, "Gerencie seu tempo, fa\xE7a o que voc\xEA quiser");
        ...
        _createClass(UserBarComponent, [{
          ...
          value: function loadUserData() {
            ...
            var interval = setInterval(function () {
              _this.storage.get("mia_user_data").then(function (user) {
                _this.userData = user[0];
                console.log("user", _this.userData);
    ...
    /***/
    "hejP": function hejP(module, __webpack_exports__, __webpack_require__) {
      "use strict";
